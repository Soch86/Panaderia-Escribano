...
## Publicar (5 minutos)
1. En tu repositorio de GitHub, sube TODOS los archivos de esta carpeta (index.html, manifest.webmanifest, sw.js, icon-*.png). Si en GitHub hay un app.html de versiones anteriores, bórralo..
...
3. Copia el Client ID y pégalo en index.html sustituyendo  window.__PWA__=true;  por  window.__PWA__=true;window.__GOOGLE_CLIENT_ID__='TU_CLIENT_ID';  (está en la primera línea del <head>)
