...
## Publicar (5 minutos)
1. En tu repositorio de GitHub, sube TODOS los archivos de esta carpeta (index.html, app.html, manifest.webmanifest, sw.js, icon-*.png).
...
3. Copia el Client ID y pégalo en app.html sustituyendo  window.__PWA__=true;  por  window.__PWA__=true;window.__GOOGLE_CLIENT_ID__='TU_CLIENT_ID';  (está en la primera línea del <head>)
   (o pásamelo y lo dejo puesto).

## Actualizar la app
Sustituye app.html por la nueva versión y sube el cambio. Los móviles la actualizan solas al abrirla.
